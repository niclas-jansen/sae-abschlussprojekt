...
var elementEngine = {
    ...
    findUid: function(source: any, uid: number) {
    ...
    addElement: function(target: any, element: any) {
    ...
    // logToDataV2: function(elementData: any, nodeTarget: any, dataTarget: any, jsonBool: boolean) {
    ...
    //     }
    //     if (jsonBool) {
    //         let elementDataJSONified = JSON.stringify(elementData);
    //         localStorage.setItem(this.localStorageTarget, elementDataJSONified);
    //     }
    //     return elementDataUid;
    // },

    createElement: function(elementObj: any, logBool: boolean, nodeTargetIdentifier: number) {
...
sectionBttn.addEventListener('click', function() {
    ...
    // elementEngine.htmlFromData(elementBase.section, true);
});
...
var createPseudoElements = function() {
    var nodeList: any = document.querySelectorAll('[uid]');
